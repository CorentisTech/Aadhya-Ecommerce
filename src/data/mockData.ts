...
export const PRODUCTS: Product[] = [
  {
    ...
    mrp: 3499,
    discount: 28,
    description: 'Crisp striped shirt dress crafted in fine cotton featuring utility pockets, a tailored collar, and tie waist belt.',
    image: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=600&auto=format&fit=crop',
    visualType: 'dress',
    visualColor: '#E8A598',
    department: 'fashion',
  ...
  {
    id: 'f-prod-cat-2',
    name: 'Fine Cotton Blazer Dress',
    category: 'Western',
    price: 5499,
    mrp: 7999,
    discount: 31,
    description: 'Architectural tailored double-breasted cotton blazer dress designed with notched lapels and structured shoulders.',
  ...
  },
  {
    ...
    mrp: 6999,
    discount: 28,
    description: 'Regal royal festive Chanderi silk anarkali suit embellished with hand-embroidered zari borders and silk dupatta.',
    image: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?q=80&w=600&auto=format&fit=crop',
    visualType: 'ethnic',
    visualColor: '#9A7955',
    department: 'fashion',
  ...
  },
  {
    ...
    mrp: 3299,
    discount: 24,
    description: 'Artisanal handwoven gold zari silk blouse with intricate neck work, back tassel ties, and padded inner lining.',
    ...
    rating: 5.0,
    reviewsCount: 112,
    occasion: 'ARTISAN WEAVES',
    fabric: 'Raw Silk',
    bestseller: true
  },
  {
    id: 'f-new-1',
    name: 'Emerald Georgette Maxi Gown',
    category: 'Dresses',
    price: 3899,
    mrp: 5499,
    discount: 29,
    description: 'Bespoke runway silhouette tailored from pure emerald green georgette with hand-pleated tiered flare and gold back zip.',
  ...
  },
  {
    ...
    mrp: 8999,
    discount: 28,
    description: 'Heritage handwoven Banarasi katan silk saree featuring regal floral zari jaal and opulent gold borders.',
    ...
    rating: 5.0,
    reviewsCount: 142,
    occasion: 'ROYAL HERITAGE',
    fabric: 'Raw Silk',
    bestseller: false
  },
  {
    id: 'f-new-3',
    name: 'Crimson Velvet Embroidered Kaftan',
    category: 'Occasion Wear',
    price: 4299,
    mrp: 5999,
    discount: 28,
    description: 'Luxe crimson micro-velvet kaftan with elaborate dabka and sequin embroidery across the lapel and sleeves.',
