...
export const NewArrivals: React.FC = () => {
  ...
  return (
    <section id="new-arrivals" className="w-full py-10 md:py-20 px-4 md:px-12 lg:px-24 bg-brand-warmWhite border-b border-brand-border/40 overflow-hidden">
      <div className="max-w-6xl mx-auto space-y-8 md:space-y-12">
        ...
        {/* Horizontal scroll container (Compacted cards side-by-side to show 1.4 - 1.8 items) */}
