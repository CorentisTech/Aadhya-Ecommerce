...
export const Marquee: React.FC = () => {
  ...
  return (
    <div className="w-[105vw] -ml-[2.5vw] bg-[#F4511E] py-4 overflow-hidden relative z-20 shadow-sm select-none transform -rotate-2 md:-rotate-1 hover:rotate-0 transition-transform duration-300">
