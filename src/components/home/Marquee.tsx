...
export const Marquee: React.FC = () => {
  ...
  return (
    <div className="w-[105vw] -ml-[2.5vw] bg-[#F26A2E] py-2 md:py-3.5 -mt-6 md:-mt-10 overflow-hidden relative z-20 shadow-sm select-none transform -rotate-2 md:-rotate-1">
